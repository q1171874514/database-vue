...
t.setup = {}
t.setup.state0 = 'Available'
t.setup.state1 = 'Not available'
t.setup.saveType0 = 'Default'
t.setup.saveType1 = 'Initial'
t.setup.updateType0 = 'Modifiable'
t.setup.updateType1 = 'Not Modifiable'
t.setup.state = [t.setup.state0, t.setup.state1]
t.setup.saveType = [t.setup.saveType0, t.setup.saveType1]
t.setup.updateType = [t.setup.updateType0, t.setup.updateType1]

t.warehouse = {}
t.warehouse.state0 = "in use"
t.warehouse.state1 = "not use"
t.warehouse.state = [t.warehouse.state0, t.warehouse.state1]
