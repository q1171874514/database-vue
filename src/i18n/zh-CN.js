...
t.setup.state0 = '可用'
t.setup.state1 = '不可用'
t.setup.saveType0 = '默认'
t.setup.saveType1 = '初始'
t.setup.updateType0 = '可改'
t.setup.updateType1 = '不可改'
...
t.warehouse = {}
t.warehouse.state0 = "在使用"
t.warehouse.state1 = "无人用"
t.warehouse.state = [t.warehouse.state0, t.warehouse.state1]
t.warehouse.folder = ["在使用", "回收站", "不可用"]
export default t
